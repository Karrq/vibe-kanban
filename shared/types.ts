...
export type TaskWithProject = { id: string, project_id: string, title: string, description: string | null, status: TaskStatus, created_at: string, updated_at: string, project_name: string, has_running_attempt: boolean, };
